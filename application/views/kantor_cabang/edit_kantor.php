                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    <?=form_open_multipart('admin/kantor_cabang_edit', 'role="form"')?>
                                    <input type="hidden" name="id_cabang" value="<?=$kantor_cabang['id_cabang']?>">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="nama_cabang" class="form-control" value="<?=$kantor_cabang['nama_cabang']?>" required maxlength="50">
                                            </div>
                                        </div>
                                    </div>
