                    ...
                    <!-- <div class="max-width-col"> -->
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#meaning" data-toggle="tab" class="tab_meaning">Meaning</a></li>
                                <li role="presentation"><a href="#keyword" data-toggle="tab" class="tab_keyword">Keyword</a></li>
                                <li role="presentation"><a href="#arranging" data-toggle="tab" class="tab_arranging">Arranging</a></li>
                            </ul>
                                        ...
                                        <tbody class="meaning">
                                            <?php $no = 1; foreach($meaning_spontan as $ms) :?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?=getNameSubject($ms['subject'], $ms['level'])?></td>
                              ...
                              <div role="tabpanel" class="tab-pane fade" id="keyword">
                                  <div class="body table-responsive">
                                      <table class="table table-bordered table-striped table-hover table_history">
                                          ...
                                          <tbody class="keyword">
                                            <?php $no1 = 1; foreach($keyword_spontan  as $ks) :?>
                                                <tr>
                              ...
                              <div role="tabpanel" class="tab-pane fade" id="arranging">
                                <div class="body table-responsive">
                                    <table class="table table-bordered table-striped table-hover table_history">
                                        ...
                                        <tbody class="arranging">
                                          <?php $no2 = 1; foreach($arranging_spontan  as $as) :?>
                                              <tr>
