                        ...
                        <div align="center">
                            ...
                            <div class="body">
                                <ul class="nav nav-tabs tab-col-amber" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#quiz_pass" data-toggle="tab">DIALOG PASSED</a>
                                    </li>
                                    <li role="presentation">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="quiz_pass">
                                    <div align="center">
                                        <h2 style="font-size:22px;">Top 10 Dialog Passed</h2>
                                    </div>
                                    <div class="body table-responsive">
                                        <table class="table">
                                            <thead>
...
<script>
    ...
    $(document).ready(function(){
        $('#btn_proses').on("click", function() {
            ...
            $.ajax({
                url: "<?=base_url()?>leaderboard/proses_leaderboard_dialog",
                type: "POST",
