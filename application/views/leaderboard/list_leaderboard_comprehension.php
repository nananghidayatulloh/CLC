<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>LEADERBOARD COMPREHENSION</h2>
        </div>
                        ...
                        <div align="center">
                            ...
                            <div class="body">
                                <ul class="nav nav-tabs tab-col-amber" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#quiz_pass" data-toggle="tab">COMPREHENSION PASSED</a>
                                    </li>
                                    <li role="presentation">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="quiz_pass">
                                    <div align="center">
                                        <h2 style="font-size:22px;">Top 10 Comprehension Passed</h2>
                                    </div>
                                    <div class="body table-responsive">
                                        <table class="table">
                                            <thead>
...
<script>
    ...
    $(document).ready(function(){
        $('#btn_proses').on("click", function() {
            ...
            $.ajax({
                url: "<?=base_url()?>leaderboard/proses_leaderboard_comprehension",
                type: "POST",
                ...
                success: function (data) {
                    ...
                    //======== QUIZ PASS ========//
                    data_quiz_pass    = parse.quiz_pass;
                    html_quiz_pass    = "";
                    no_quiz_pass = 1;
                    for (var i = 0; i < data_quiz_pass.length; i++) {
                        html_quiz_pass +=   `<tr>
                                            <td class="text-center">`+no_quiz_pass+`</td>
                                            <td class="text-center">`+data_quiz_pass[i]['nama_siswa']+`</td>
                                            <td class="text-center">`+data_quiz_pass[i]['nama_cabang']+`</td>
                                            <td class="text-center">`+data_quiz_pass[i]['total']+`</td>
                                        </tr>`;
                        no_quiz_pass++
                    }
                    ...
                    $('#tbl_quiz_pass').html(html_quiz_pass);
