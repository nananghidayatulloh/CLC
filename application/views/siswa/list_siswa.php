                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" id="table_siswa">
                                <thead>
                                    <tr>
        ...
        <div class="modal fade" id="smallModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <!-- action="<?php echo base_url(); ?>admin/upload_siswa" > -->
...
$(document).ready(function(){
    ...
    let table           = $('#table_siswa').DataTable();
    let array_selected  = [];
            ...
            if (this.checked) {
                ...
                $('input[name="checkbox"]', rows).addClass('selected');
                    for (let index = 1; index <= rows_length; index++) {
                        ...
                        // array_selected[(index - 1)]  = id_siswa;
                        // array_selected.push(id_siswa);
