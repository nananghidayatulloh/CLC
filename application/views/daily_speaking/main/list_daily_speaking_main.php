    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Daily Speaking Main
                        <ol class="breadcrumb pull-right">
                            <li><a href="<?=base_url()?>daily_speaking/daily_speaking_main"><i class="material-icons">file_upload</i> Upload Content</a></li>
                                ...
                                <div id="upload" style="display:none">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?=form_open('daily_speaking/upload_daily_speaking', "id='form_daily_speaking'"); ?>
                                            <div class="input-group">
                                                ...
                                                <input name="mode" value="daily_speaking_main" hidden>
                                                <div class="form-line">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="mode" value="daily_speaking_audio_main" hidden>
                                            <div class="form-line">
...
<script>
    ...
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success : function(hasil){
                    ...
                    $.each(parsedata, function( index, value ) {
                        var file_name = value;
                            url = '<?=base_url()?>daily_speaking/download_daily_speaking_file?level='+level+'&unit='+unit+'&file_name='+file_name+'&mode=daily_speaking_main';
        ...
        $.show_audio_file = function() {
            ...
            var level       = $('#selectlevel').val();
                unit        = $('#selectunit').val();
                mode        = "daily_speaking_audio_main"
