...
$(document).ready(function(){
  ...
  $(".choosen-level").on('change', function(){
    $.ajax({
    url:'<?php echo base_url("lesson_plan/get_unitt/") ?>'+$(this).val(),
    type:'POST',
  ...
  $(".choosen-unit").on('change', function(){
    ...
    $.ajax({
    url:'<?php echo base_url("lesson_plan/get_exam_story/") ?>'+$('#level').val()+'/'+$(this).val(),
    type:'POST',
    success: function(data){
  ...
  $('.btn_simpan').on('click', function(){
    ...
    $('.id_story').each(function(){
      id_story.push($(this).val());
        ...
        $.ajax({
        url:'<?php echo base_url("lesson_plan/save_exam/") ?>',
        type:'POST',
        data : {
          'story[]' : story,
          'id_story[]' : id_story,
