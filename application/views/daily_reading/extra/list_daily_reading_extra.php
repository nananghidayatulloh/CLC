    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Daily Reading Extra
                                ...
                                <div id="upload" hidden>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?=form_open_multipart('daily_reading/daily_reading_upload_story', "id='formStory'"); ?>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="mode" value="da_story_extra" hidden>
                                                <div class="form-line">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="mode" value="da_audio_extra" hidden>
                                            <div class="form-line">
                ...
                success : function(hasil){
                    ...
                    if (hasil.name.length != 0) {
                        $.each(hasil.name, function( index, value ) {
                            var file_name   = value;
                                var url = '<?=base_url()?>daily_reading/daily_reading_download_story_file_new?level='+level+'&unit='+unit+'&story='+story+'&mode=da_story_extra';
