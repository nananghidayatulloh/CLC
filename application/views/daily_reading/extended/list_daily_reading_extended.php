    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Daily Reading Extended
                            <ol class="breadcrumb pull-right">
                                <li> <a href="<?=base_url()?>daily_reading"><i class="material-icons">file_upload</i> Upload Content </a></li>
                                <li>Daily Reading</li>
                                <li class="active">Extended</li>
                            </ol>
                        </h2>
                    </div>
                    <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div id="upload" hidden>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <?=form_open_multipart('daily_reading/daily_reading_upload_story', "id='formStory'"); ?>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="mode" value="da_story_extended" hidden>
                                                <div class="form-line">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?=form_open_multipart('daily_reading/daily_reading_upload_audio', 'id="formAudio1"')?>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="mode" value="da_audio_extended" hidden>
                                            <div class="form-line">
...
<script>
    $(document).ready(function(){
        ...
        function show_unit_name() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_unit_name_new',
                method: "POST",
        ...
        function show_story_name() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_story_name_new',
                method: "POST",
                data: {level : level, unit : unit, story : story, mode : mode},
                async: true,
                dataType: 'JSON',
                success: function(hasil) {
        ...
        function show_story_file() {
            ...
            var level       = $('#selectlevel').val();
                unit        = $('#selectunit').val();
                story       = $('#selectstory').val();
                mode        = "da_story_extended";
                
            $.ajax({
                url     : '<?=base_url()?>daily_reading/daily_reading_story_file_new',
                method  : 'POST',
                data    : {level : level, unit : unit, story : story, mode : mode},
                async   : true,
                dataType: 'JSON',
                success : function(hasil){
                    ...
                    if (hasil.name.length != 0) {
                        $.each(hasil.name, function( index, value ) {
                            var file_name   = value;
                                var url = '<?=base_url()?>daily_reading/daily_reading_download_story_file_new?level='+level+'&unit='+unit+'&story='+story+'&mode=da_story_extended';
        ...
        function show_audio_file1() {
            ...
            var level       = $('#selectlevel').val();
                unit        = $('#selectunit').val();
                story       = $('#selectstory').val();
                mode        = "da_audio_extended"
                
            $.ajax({
                url     : '<?=base_url()?>daily_reading/daily_reading_audio_file_new',
                method  : 'POST',
                data    : {level : level, unit : unit, story : story, speed : "Level1", mode : mode},
                async   : true,
                dataType: 'JSON',
                success : function(hasil){
                    $.each(hasil, function( index, value ) {
                            ...
                            var txt1 = $(`  <div class='col-sm-4' align='center'>
                                                <tr>
                                                    <th>`+file_name+`</th>
                                                    <th>
                                                        <button type='button' class='btn btn-xs bg-red waves-effect' onclick="$.delete_data('`+file_name+`','Level1')"> Delete </button>
                                                    </th>
                                                <tr>
                                            </div>`);
                            $('#dir1').append(txt1)
        ...
        //         url     : '<?=base_url()?>daily_reading/daily_reading_audio_file_new',
        //         method  : 'POST',
        //         data    : {level : level, unit : unit, story : story, speed : "Level2", mode : mode},
        //         async   : true,
        //         dataType: 'JSON',
        //         success : function(hasil){
        //             $.each(hasil, function( index, value ) {
        ...
        //                                             <th>`+file_name+`</th>
        //                                             <th>
        //                                                 <button type='button' class='btn btn-xs bg-red waves-effect' onclick="$.delete_data('`+file_name+`', 'Level2')"> Delete </button>
        //                                             </th>
        //                                         <tr>
        //                                     </div>`);
        //                     $('#dir2').append(txt1)
        ...
        //         url     : '<?=base_url()?>daily_reading/daily_reading_audio_file_new',
        //         method  : 'POST',
        //         data    : {level : level, unit : unit, story : story, speed : "Level3", mode : mode},
        //         async   : true,
        //         dataType: 'JSON',
        //         success : function(hasil){
        //             $.each(hasil, function( index, value ) {
        ...
        //                                             <th>`+file_name+`</th>
        //                                             <th>
        //                                                 <button type='button' class='btn btn-xs bg-red waves-effect' onclick="$.delete_data('`+file_name+`', 'Level3')"> Delete </button>
        //                                             </th>
        //                                         <tr>
        //                                     </div>`);
        //                     $('#dir3').append(txt1)
        ...
        $.delete_story = function(file_name) {
            var file_name   = file_name;
                ...
                mode        = "da_story_extended"
            $.ajax({
            url     : '<?=base_url()?>daily_reading/daily_reading_delete_story_new',
            method  : "POST",
        ...
        $('#submit_form_story').on('click', function(e){
            ...
            $.ajax({
                ...
                type : 'POST',
                url : '<?=base_url()?>daily_reading/daily_reading_upload_story_new',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $('#submit_file_audio1').on('click', function(e){
            ...
            $.ajax({
                ...
                type : 'POST',
                url : '<?=base_url()?>daily_reading/daily_reading_upload_audio_new',
                data : formData,
                processData : false,
                contentType : false,
                success : function(feedback){
        ...
        //         success : function(feedback){
        //             Swal('Selamat Berhasil Upload File', feedback, 'success');
        //             $("#files_audio2").replaceWith($("#files_audio2").val('').clone(true));
        ...
        //         success : function(feedback){
        //             Swal('Selamat Berhasil Upload File', feedback, 'success');
        //             $("#files_audio3").replaceWith($("#files_audio3").val('').clone(true));
        ...
        $('#selectunit').on('change', function(){
            ...
            $.ajax({
                ...
                url: '<?=base_url()?>daily_reading/dialy_reading_story',
                method: 'POST',
        ...
        $('#submit_unit_name').on('click', function() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_update_unit_new',
                method: 'POST',
        ...
        $('#submit_story_name').on('click', function() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_update_story_new',
                method: 'POST',
                data : {level : level, unit : unit, story : story, story_name_baru : story_name_baru, mode : mode},
                async: true,
                dataType : 'JSON',
                success : function(data) {
                    Swal('Berhasil', data.name, 'success');
        ...
        $('#submit_clear_data').on('click', function() {
            ...
            $.ajax ({
                url     : '<?=base_url()?>daily_reading/daily_reading_clear_data_content_new',
                method  : "POST",
                data    : {level : level, unit : unit, story : story, mode : mode},
                async   : true,
                dataType: 'JSON',
        ...
        $.delete_data = function(file_name, speed) {
            var level       = $('#selectlevel').val();
                unit        = $('#selectunit').val();
                story       = $('#selectstory').val();
                mode        = "da_audio_extended";
            $.ajax ({
                url     : '<?=base_url()?>daily_reading/daily_reading_data_audio_new',
                method  : "POST",
                data    : {level : level, unit : unit, story : story, file_name : file_name, speed : speed, mode : mode},
                async   : true,
                dataType: 'JSON',
                success: function (hasil) {
                    show_story_file();
