...
<script>
    $(document).ready(function(){
        ...
        function show_unit_name() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_unit_name',
                method: "POST",
        ...
        function show_story_name() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_story_name',
                method: "POST",
        ...
        function show_story_file() {
            ...
            $.ajax({
                url     : '<?=base_url()?>daily_reading/daily_reading_story_file',
                method  : 'POST',
                data    : {level : level, unit : unit, story : story},
                async   : true,
                dataType: 'JSON',
                success : function(hasil){
                    ...
                    if (hasil.name.length != 0) {
                        $.each(hasil.name, function( index, value ) {
                            var file_name   = value;
                                var url = '<?=base_url()?>daily_reading/daily_reading_download_story_file?level='+level+'&unit='+unit+'&story='+story;
        ...
        function show_audio_file1() {
            ...
            $.ajax({
                url     : '<?=base_url()?>daily_reading/daily_reading_audio_file',
                method  : 'POST',
        ...
        $.delete_story = function(file_name) {
            ...
            $.ajax({
            url     : '<?=base_url()?>daily_reading/daily_reading_delete_story',
            method  : "POST",
        ...
        $('#submit_form_story').on('click', function(e){
            ...
            $.ajax({
                ...
                type : 'POST',
                url : '<?=base_url()?>daily_reading/daily_reading_upload_story',
                data : formData,
                processData : false,
                contentType : false,
        ...
        $('#submit_file_audio1').on('click', function(e){
            ...
            $.ajax({
                ...
                type : 'POST',
                url : '<?=base_url()?>daily_reading/daily_reading_upload_audio',
                data : formData,
                processData : false,
                contentType : false,
                success : function(feedback){
        ...
        $('#submit_unit_name').on('click', function() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_update_unit',
                method: 'POST',
        ...
        $('#submit_story_name').on('click', function() {
            ...
            $.ajax({
                url: '<?=base_url()?>daily_reading/daily_reading_update_story',
                method: 'POST',
        ...
        $('#submit_clear_data').on('click', function() {
            ...
            $.ajax ({
                url     : '<?=base_url()?>daily_reading/daily_reading_clear_data_content',
                method  : "POST",
                data    : {level : level, unit : unit, story : story},
                async   : true,
                dataType: 'JSON',
        ...
        $.delete_data = function(file_name, speed) {
            var level       = $('#selectlevel').val();
                ...
                story       = $('#selectstory').val();
            $.ajax ({
                url     : '<?=base_url()?>daily_reading/daily_reading_data_audio',
                method  : "POST",
                data    : {level : level, unit : unit, story : story, file_name : file_name, speed : speed},
                async   : true,
                dataType: 'JSON',
                success: function (hasil) {
                    show_story_file();
