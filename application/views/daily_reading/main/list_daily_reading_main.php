    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Daily Reading Main
                            <ol class="breadcrumb pull-right">
                                <li> <a href="<?=base_url()?>daily_reading/daily_reading_main"><i class="material-icons">file_upload</i> Upload Content </a></li>
                                <li>Daily Reading</li>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control show-tick" name="level" id="selectlevel" required>
                                            ...
                                            <?php if (trim($this->session->userdata('role_user')) === 'admin') : ?>
                                                <option value="TES_1">TES_1</option>
                                            <?php else : ?>
                                                <option value=""> - Pilih Level - </option>
                                ...
                                <div id="upload" hidden>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?=form_open_multipart('daily_reading/daily_reading_upload_story', "id='formStory'"); ?>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="mode" value="da_story_main" hidden>
                                                <div class="form-line">
                                                    <input type="file" name="files" id="files_story" accept=".txt" class="form-control" required>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="mode" value="da_audio_main" hidden>
                                            <div class="form-line">
                ...
                success : function(hasil){
                    ...
                    if (hasil.name.length != 0) {
                        $.each(hasil.name, function( index, value ) {
                            var file_name   = value;
                                var url = '<?=base_url()?>daily_reading/daily_reading_download_story_file_new?level='+level+'&unit='+unit+'&story='+story+'&mode=da_story_main';
