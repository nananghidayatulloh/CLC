    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Dialog Extra
                        <ol class="breadcrumb pull-right">
                            <li><a href="<?=base_url()?>dialog/dialog_extra"><i class="material-icons">file_upload</i> Upload Content</a></li>
                            <li>Dialog</li>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <?=form_open_multipart('dialog/upload_dialog_new', "id='formDialog'"); ?>
                                                <div class="input-group">
                                                    ...
                                                    <input name="mode" value="dialog_extra" hidden>
                                                    <div class="form-line">
            ...
            $.ajax({
                ...
                success : function(hasil){
                    ...
                    $.each(parsedata, function( index, value ) {
                        var file_name = value;
                            url = '<?=base_url()?>dialog/download_dialog_file_new?level='+level+'&file_name='+file_name+'&mode=dialog_extra';
