    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Comprehension Extra
                        <ol class="breadcrumb pull-right">
                            <li><a href="<?=base_url()?>comprehension/comprehension_extra"><i class="material-icons">file_upload</i> Upload Content</a></li>
                            <li>Comprehension</li>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="comprehension" style="display:none">
                                        <div class="col-md-8">
                                            ...
                                            <?=form_open_multipart('comprehension/upload_comprehension_new', "id='form_comprehension'"); ?>
                                                <div class="input-group">
                                                    <input name="level" id="level_comprehension" hidden>
                                                    <input name="mode" value="comprehension_extra" hidden>
                                                    <div class="form-line">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.show_file = function() {
            ...
            var level = $('#selectlevel').val();
                mode  = "comprehension_extra";

            $.ajax({
                url     : '<?=base_url()?>comprehension/comprehension_list_file_new',
                method  : 'POST',
                ...
                success : function(hasil){
                    ...
                    $.each(parsedata, function( index, value ) {
                        var file_name = value;
                            url = '<?=base_url()?>comprehension/download_comprehension_file_new?level='+level+'&file_name='+file_name+'&mode=comprehension_extra';
        ...
        $.delete_data = function(file_name) {
            ...
            $.ajax({
            url     : "<?=base_url()?>comprehension/delete_comprehension_file_new",
            method  : "POST",
    ...
    $('#submit_comprehension').on("click", function (e) {
        ...
        $.ajax({
            url: "<?=base_url()?>comprehension/upload_file_comprehension_new",
            method: "POST",
    ...
    $('#clear_data_content').on("click", function(e) {
        ...
        $.ajax ({
            url         : '<?=base_url()?>comprehension/comprehension_clear_data_content_new',
            method      : "POST",
            data        : {level : level, mode : mode},
            async       : true,
            dataType    : 'JSON',
