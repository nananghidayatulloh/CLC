    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Upload Content Comprehension Main
                        <ol class="breadcrumb pull-right">
                            <li><a href="<?=base_url()?>comprehension/comprehension_main"><i class="material-icons">file_upload</i> Upload Content</a></li>
                            <li>Comprehension</li>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <?=form_open_multipart('comprehension/upload_comprehension_new', "id='form_comprehension'"); ?>
                                                <div class="input-group">
                                                    ...
                                                    <input name="mode" value="comprehension_main" hidden>
                                                    <div class="form-line">
            ...
            $.ajax({
                ...
                success : function(hasil){
                    ...
                    $.each(parsedata, function( index, value ) {
                        var file_name = value;
                            url = '<?=base_url()?>comprehension/download_comprehension_file_new?level='+level+'&file_name='+file_name+'&mode=comprehension_main';
